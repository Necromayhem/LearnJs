...
theadTr.append(nameTh, ageTh, actionTh)
...
function getStudentTr(name, age, height) {
  ...
  studentTr.append(nameTd, ageTd, removeTd)
  return studentTr
}
...
addNewBtn.onclick = function () {
  ...
  let newStudentTr = getStudentTr(name, age)
...
addBox.append(nameInp, ageInp, addNewBtn)
